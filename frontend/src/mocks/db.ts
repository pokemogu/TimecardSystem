export const holidays: { date: Date, name: string }[] = [
...
export const sections: { id: number, department: number, name: string }[] = [
...
export const recordTypes: { id: number, name: string, description: string }[] = [
...
export const applyTypes: { id: number, name: string, isSystemType: boolean, description: string }[] = [
...
export const applyOptionTypes: { id: number, type: number, name: string, isSystemType: boolean, description: string }[] = [
...
export const applyOptionTypeValues: { id: number, optionType: number, name: string, isSystemType: boolean, description: string }[] = [
...
export const devices: { id: number, name: string }[] = [
  { id: 1, name: '打刻端末1' },
  { id: 2, name: '打刻端末2' },
  { id: 3, name: '打刻端末3' },
  { id: 4, name: '打刻端末4' },
